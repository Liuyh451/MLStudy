...
if __name__ == '__main__':
    ...
    trainDataList, trainLabelList = loadData('D:/python/lyh/MachineLearning/SVM/ds_csv/train.csv')
    # 获取测试集及标签
    print('start read testSet')
    testDataList, testLabelList = loadData('D:/python/lyh/MachineLearning/SVM/ds_csv/test.csv')
    ...
    print(metrics.classification_report(testLabelList[:60],prelabel,target_names=target_names))
    print("Precision_score:",Get_Precision_score(testLabelList[:60],prelabel))
    print("Recall:",Get_Recall(testLabelList[:60],prelabel))
    print("f1_score",Get_f1_score(testLabelList[:60],prelabel))
    # 打印时间
